      ...
      <div className="p-6 space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Gestiona usuarios, contenido reportado y supervisa la actividad de la plataforma
          </p>
          <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Sesión activa: <span className="font-semibold">{user.email}</span> | Rol:{" "}
            <span className="font-semibold text-blue-600 dark:text-blue-400">{user.role}</span>
          </div>
        </div>

        {/* Tabs de navegación */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
          <div className="flex gap-2 justify-evenly p-2 overflow-x-auto">
            <button
