  ...
  return (
    <div className="text-Oscuro flex w-full flex-col items-start justify-center mt-4">
      ...
      <input
        id={id}
        {...props}
        className="text-gray-700 bg-gray-100 focus:border-[#ffff00] mb-1 w-full rounded-lg px-3 py-2  text-lg transition duration-300 invalid:border-red-500 invalid:ring-1 invalid:ring-red-500 focus:ring-2 focus:outline-[#ffff00]"
      />
    </div>
  );
};
