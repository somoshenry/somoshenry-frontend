    ...
    switch (status) {
      ...
      case 'success':
        return {
          ...
          message:
            'Tu suscripción se activó correctamente. Ya podés disfrutar de todos los beneficios.',
      ...
      case 'failure':
        return {
          ...
          message:
            'Tu pago no pudo completarse. Probá nuevamente o elegí otro método de pago.',
