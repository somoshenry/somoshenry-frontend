...
const PricingCard: React.FC<PricingCardProps> = ({ plan, isCurrentPlan, onUpgrade }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl p-8 ${plan.borderColor} bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 ${
    ...
    >
      ...
      {isCurrentPlan && (
        <div className="absolute top-5 -right-8 bg-blue-500 text-white px-10 py-1 rotate-45 text-xs font-semibold uppercase shadow-md">Actual</div>
      )}
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-16 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-xl p-6 shadow-md">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">Tipo de Plan</h3>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-xl p-6 shadow-md">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">Fecha de Expiración</h3>
                ...
                {daysRemaining !== null && (
                  <p className={`text-sm font-medium ${daysRemaining <= 7 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900 dark:to-purple-800 rounded-xl p-6 shadow-md">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">Posteos Restantes</h3>
                ...
                <div className="mt-3 bg-white dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                  <div
                    className={`h-full transition-all duration-300 ${
                      subscriptionData.postsRemaining === -1 ? 'bg-purple-500 w-full' :
                      (subscriptionData.postsRemaining / subscriptionData.postsLimit) > 0.5 ? 'bg-green-500' :
                      (subscriptionData.postsRemaining / subscriptionData.postsLimit) > 0.2 ? 'bg-yellow-500' : 'bg-red-500'
                    }`}
                    style={{
                      width: subscriptionData.postsRemaining === -1 ? '100%' : 
        ...
        <div className="mb-8">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">Actualiza tu suscripción para acceder a más beneficios</p>
        </div>
